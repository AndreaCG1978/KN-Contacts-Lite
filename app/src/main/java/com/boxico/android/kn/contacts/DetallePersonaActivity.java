...
public class DetallePersonaActivity extends Activity {
	...
	private void registrarViews(){
		...
		drwColorSeleccionado = res.getDrawable(R.layout.custom_text_view_categoria_desc);
		drwColorDeseleccionado = res.getDrawable(R.layout.custom_text_view_categoria);
